...
% subs = {'Sub05','Sub06','Sub08','Sub10','Sub13'};
% baseSess = [2 1 1 1 1];
% subs = {'Sub11'};
% baseSess = 1;
sessId = 1:4;
...
stimFile1 = 'STDallC100roi.1D';
stimLabel1 = 'STDallC100roi';
glm_prefix = '_GLM_STDallC100roi';
errts_prefix = 'errts';
...
for si = 1:length(subs)
    ...
    nuis_files = dir([glm_dir 'NuisanceROI*.1D']);
